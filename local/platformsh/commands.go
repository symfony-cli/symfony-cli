...
var Commands = []*console.Command{
	...
	},
	{
		...
		Flags:    []console.Flag{
			...
			&console.BoolFlag{Name: "no-wait", Aliases: []string{"W"},},
			&console.StringFlag{Name: "project", Aliases: []string{"p"},},
			&console.StringFlag{Name: "protocol", DefaultValue: "udp",},
			...
			&console.StringFlag{Name: "syslog-host", DefaultValue: "localhost",},
	...
	},
	{
		...
		Usage:    "<fg=white;bg=red>[ ALPHA ]</> Show disk usage on a service",
		Hidden:   console.Hide,
		Flags:    []console.Flag{
			&console.BoolFlag{Name: "bytes", Aliases: []string{"B"},},
			&console.StringFlag{Name: "columns",},
