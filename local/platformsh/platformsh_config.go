// Code generated by platformsh_config_generator.
// DO NOT EDIT

package platformsh

var availablePHPExts = map[string][]string{
	"amqp":            {"7.0", "7.1", "7.2", "7.3", "7.4"},
	"apc":             {"5.4", "5.5"},
	...
	"gearman":         {"5.4", "5.5", "5.6"},
	"geoip":           {"5.4", "5.5", "5.6", "7.0", "7.1", "7.2", "7.3", "7.4"},
	...
	"memcached":       {"5.4", "5.5", "5.6", "7.0", "7.1", "7.2", "7.3", "7.4", "8.0"},
	"mongo":           {"5.4", "5.5", "5.6"},
	"mongodb":         {"7.0", "7.1", "7.2", "7.3", "7.4", "8.0"},
	...
	"newrelic":        {"5.6", "7.0", "7.1", "7.2", "7.3", "7.4", "8.0"},
	...
	"tideways-xhprof": {"7.0", "7.1", "7.2", "7.3", "7.4"},
	...
	"xmlrpc":          {"5.4", "5.5", "5.6", "7.0", "7.1", "7.2", "7.3", "7.4", "8.1"},
...
var availableServices = []*service{
	{
		...
		Versions: serviceVersions{
			Deprecated: []string{},
			Supported:  []string{"73", "80", "81", "83", "84", "86", "91"},
		},
	},
	{
		Type: "elasticsearch",
